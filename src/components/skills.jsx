...
const skills = [
    ...
    //English
    { name: "Listening", level: 85, category: "English" },
    { name: "Speaking", level: 85, category: "English" },
    { name: "Reading", level: 75, category: "English" },
    { name: "Writting", level: 80, category: "English" },

];

const categories = ["all", "frontend", "tools", "English"];
